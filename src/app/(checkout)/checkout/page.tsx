  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-6">
        {/* LEFT - Shipping form */}
        <div className="w-full lg:w-6/12 min-h-screen border-r border-gray-200 py-4 pr-6 flex flex-col gap-6">
        ...
        {/* RIGHT - Order Summary */}
        <div className="w-full lg:w-6/12 bg-gray-50 rounded-lg p-6 shadow-sm h-fit">
          <h2 className="text-lg font-medium mb-4">Đơn hàng của bạn</h2>
          {/* Có thể render carts.map() ở đây */}
          <p className="text-sm text-gray-600">Tổng cộng: 1.250.000₫</p>
        </div>
      </div>
    </div>
  );
