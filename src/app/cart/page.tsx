    ...
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="flex flex-col items-start lg:flex-row lg:items-center gap-8 lg:gap-16">
        {steps.map((step) => (
          ...
          >
            ...
            <p className={cn(step.id === activeStep ? 'text-gray-800' : 'text-gray-200')}>{step.title}</p>
          </div>
        ))}
      </div>
      ...
      <div className="w-full flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-7/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
          {activeStep === 1 && carts && carts.length > 0 && (
          ...
          {activeStep === 1 ? (
            ...
            <p className="text-sm text-gray-500">Vui lòng điền đầy đủ thông tin địa chỉ giao hàng để tiếp tục !</p>
          )}
        </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-between items-center">
              ...
              <p className="text-sm font-medium">
                {carts.reduce((acc, item) => acc + item.price * item.quantity, 0).toLocaleString('vi-VN')}₫
              </p>
            </div>
          ...
          {activeStep === 1 && (
            <button
              ...
              className={cn(
                ...
                carts.length > 0
                  ? 'bg-gray-800 hover:bg-gray-900 transition-all duration-300 text-white cursor-pointer'
